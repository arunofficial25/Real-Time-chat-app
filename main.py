...
def main(page: ft.Page):
    page.title = "Ben-One Zero Messenger"
    ...
    principal_content = ft.Column(
        [
            ft.Icon(ft.icons.MESSENGER, size=200, color=ft.colors.BLUE),
            ft.Text(value="Ben-One Zero Messenger", size=50, color=ft.colors.WHITE),
        ],
        height=400,
        width=600,
        ...
        if page.route == "/chat":
            if page.session.contains_key("user"):
                ...
                page.add(
                    ft.Row(
                        [
                            ft.Text(value="Ben-One Zero messenger", color=ft.colors.WHITE),
                            ft.ElevatedButton(
                                text="Log Out",
                    ...
                    ft.Row(
                        controls=[
                            ft.IconButton(
                                ...
                                tooltip="Attach",
                                on_click=lambda e: print("Attach file"),
                            ),
                            emoji_list,
                            new_message,
                            ft.IconButton(
